...
# pop 2
# create the spike injection pop
...
ExternalDevices.activate_live_output_for(populations[1])

# create projection from spike injector to main pop

projections.append(
    Frontend.Projection(populations[2], populations[0],
                        Frontend.OneToOneConnector(weights=weight_to_spike)))

# create projection from pop 0 to pop 1 for output

projections.append(
    Frontend.Projection(populations[0], populations[1],
                        Frontend.OneToOneConnector(weights=weight_to_spike)))



# create loop connections in main pop
